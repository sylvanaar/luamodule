...
seeall_mt = {__index = _G}
package.seeall = package.seeall or function(t) return setmetatable(t, seeall_mt) end 
package.preload = package.preload or {}
package.loaders = package.loaders or {}
package.loaded = package.loaded or {}


local function tailExec(t, a, ...)
...
-- @param name The package name. If name is a compound name (that is, one with components separated by dots), module creates (or reuses, if they already exist) tables for each component. 
